...
const BookTicketsPage = ({ match }) => {
  const randomText = "This is some random text for the booking page.";
...
const BookingPage = () => {
  ...
  const handleTicketBooking = (price, index) => {
    ...
    navigate(`/payment1`, { state: { price, quantity: ticketQuantities[index] } });
  };
